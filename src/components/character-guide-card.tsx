...
export default function CharacterGuideCard({ character }: CharacterGuideCardProps) {
  return (
    <div className="bg-[#1a3759] border border-[#4d647e] rounded-xl overflow-hidden flex items-center flex-row p-4 shadow-lg h-[160px]">
      ...
      <div className="ml-4 flex-5">
        ...
        <div className="mt-2 space-y-2">
          <div className="flex justify-between mb-0 border border-[#4d647e] px-1 pr-0 rounded-xl overflow-hidden bg-[#334d6c] max-w-[200px]">
            <span className="text-white text-sm sm:text-[14px] pr-1">Quick Guide</span>
            <span className="flex items-center justify-center min-w-[35px] text-white text-sm sm:text-[14px] font-medium border-l border-[#1a3759] w-[35px] text-center bg-[#667a91]">{character.quickGuideRating}.</span>
          </div>
          ...
          <div className="flex justify-between mb-0 border border-[#4d647e] px-1 pr-0 rounded-xl overflow-hidden bg-[#334d6c] max-w-[200px]">
            ...
            <span className="flex items-center justify-center min-w-[35px] text-white text-sm sm:text-[14px] font-medium border-l border-[#1a3759] w-[35px] text-center bg-[#667a91]">{character.extendedGuideRating}.</span>
          </div>
        </div>
      </div>
    </div>
