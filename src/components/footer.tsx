...
import { DiscIcon, Facebook, Github, Instagram, Linkedin, Twitter, Youtube } from "lucide-react"
      ...
      <div className="mx-auto px-20 py-12 max-[500px]:px-6 max-w-[1100px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold">WuwaBeacon</h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/echos" className="text-gray-300 hover:text-white transition-colors">
                  Echos
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-300">
          <p>© {new Date().getFullYear()} WuwaBeacon. All rights reserved.</p>
