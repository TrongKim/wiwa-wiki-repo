...
import FilterWeaponPopup from "./popup-filter-weapon"
...
export function WeaponHeader({ onChangeFilter }: Props) {
    ...
    return (
        <>
            ...
            <FilterWeaponPopup isOpen={isOpenFilterPopup} onClickChangeState={onClickChangeStateFilterPopup} onChangeFilter={(value) => setFilter(value)} />
        </>
    )
}
