...
import { CharacterResonanceChain } from './character-resonance-chain'
import { CharacterGuide } from './character-guide'
import { Backstory } from './back-story'
    ...
    useEffect(() => {
        ...
        switch (mode) {
            ...
            case 'resonance-chain':
                setPageDetail(<CharacterResonanceChain params={ { id: Number(id) } } />)
                break
            case 'guides':
                setPageDetail(<CharacterGuide />)
                break
            case 'backstory':
                setPageDetail(<Backstory />)
                break
            case 'voice':
                setPageDetail(<Voice />)
                break
